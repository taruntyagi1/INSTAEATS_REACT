...
class CartItem(models.Model):
    ...
    product = models.ForeignKey(
        Product, on_delete=models.SET_NULL, null=True, blank=True, related_name='product')
    variant = models.ForeignKey(
        Variant, on_delete=models.SET_NULL, null=True, blank=True, related_name='variants')
    price = models.IntegerField(null = True, blank=True,default= 0)
