    ...
    return(
        <div className="header">
            ...
            <div className="nav-bar">
                ...
                <button> <li className="nav-link"><Link to='/login_form'>LOgin form</Link></li></button>
                    ...
                    <li id="cart_btn" className="nav-link"><Link to='/cart'><FiShoppingCart /><i>{count}</i></Link></li>
                    </ul>
